...
function dynamicContentDetails(object)
{
    ...
    for(i=0; i<object.photos.length; i++)
    {
        ...
        imgTagProductPreviewDiv.classList='blueborder';
...
let = document.querySelector(".previewImg").querySelectorAll("img");
console.log(let);
let.forEach((element) => {
  element.addEventListener("click", function () {
    let.forEach((nav) => nav.classList.remove("blueborder"));

    this.classList.add("blueborder");
  });
});